...
/** 
 * DAO for table "BOOK_COLLECT_BEAN".
*/
public class BookCollectBeanDao extends AbstractDao<BookCollectBean, String> {

    public static final String TABLENAME = "BOOK_COLLECT_BEAN";

    /**
     * Properties of entity BookCollectBean.<br/>
    ...
    public BookCollectBeanDao(DaoConfig config) {
        super(config);
    }
    
    public BookCollectBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK_COLLECT_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BOOK_COLLECT_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BookCollectBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BookCollectBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public BookCollectBean readEntity(Cursor cursor, int offset) {
        BookCollectBean entity = new BookCollectBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, BookCollectBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(BookCollectBean entity, long rowId) {
        return entity.getNoteUrl();
    }
    
    @Override
    public String getKey(BookCollectBean entity) {
        if(entity != null) {
            return entity.getNoteUrl();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BookCollectBean entity) {
