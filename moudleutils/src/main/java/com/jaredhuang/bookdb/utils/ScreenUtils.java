package com.jaredhuang.bookdb.utils;
...
import com.jaredhuang.bookdb.UtilsExt;
...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = UtilsExt.getInstance().getContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = UtilsExt.getInstance().getContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return UtilsExt.getInstance().getContext()
                .getResources()
                .getDisplayMetrics();
    }
}
