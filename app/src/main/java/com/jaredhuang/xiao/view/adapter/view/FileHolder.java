package com.jaredhuang.xiao.view.adapter.view;
...
import com.jaredhuang.xiao.view.adapter.base.ViewHolderImpl;
...
public class FileHolder extends ViewHolderImpl<File> {
    ...
    private void setFile(File file) {
        ...
        if (BookCollectHelp.getBook(file.getAbsolutePath()) != null) {
