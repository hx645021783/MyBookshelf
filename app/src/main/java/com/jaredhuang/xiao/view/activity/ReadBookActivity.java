...
import com.jaredhuang.xiao.help.ChapterContentHelp;
import com.jaredhuang.xiao.help.ReadBookControl;
import com.jaredhuang.xiao.help.permission.Permissions;
import com.jaredhuang.xiao.help.permission.PermissionsCompat;
...
import com.jaredhuang.xiao.utils.SoftInputUtil;
import com.jaredhuang.xiao.utils.StringUtils;
import com.jaredhuang.xiao.utils.SystemUtil;
import com.jaredhuang.xiao.utils.bar.BarHide;
...
import com.jaredhuang.xiao.view.popupwindow.CheckAddShelfPop;
import com.jaredhuang.xiao.view.popupwindow.MediaPlayerPop;
import com.jaredhuang.xiao.view.popupwindow.MoreSettingPop;
import com.jaredhuang.xiao.view.popupwindow.ReadAdjustMarginPop;
import com.jaredhuang.xiao.view.popupwindow.ReadAdjustPop;
import com.jaredhuang.xiao.view.popupwindow.ReadBottomMenu;
import com.jaredhuang.xiao.view.popupwindow.ReadInterfacePop;
import com.jaredhuang.xiao.view.popupwindow.ReadLongPressPop;
import com.jaredhuang.xiao.widget.modialog.BookmarkDialog;
import com.jaredhuang.xiao.widget.modialog.ChangeSourceDialog;
import com.jaredhuang.xiao.widget.modialog.DownLoadDialog;
import com.jaredhuang.xiao.widget.modialog.InputDialog;
import com.jaredhuang.xiao.widget.modialog.MoDialogHUD;
import com.jaredhuang.xiao.widget.modialog.ReplaceRuleDialog;
...
public class ReadBookActivity extends MBaseActivity<ReadBookContract.Presenter> implements ReadBookContract.View, View.OnTouchListener {
    ...
    private void initPageView() {
        mPageLoader = pageView.getPageLoader(this, mPresenter.getBookShelf(),
                new PageLoader.OnPageLoaderCallback() {
                    /**
                     * @param pos:切换章节的序号
                     */
                    @Override
        ...
        mPageLoader.setOnNetLoaderCallback(new PageLoader.OnNetLoaderCallback() {
    ...
    @Override
    public void changeSourceFinish(BookCollectBean book) {
