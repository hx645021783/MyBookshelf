...
import com.jaredhuang.xiao.utils.BitmapUtil;
import com.jaredhuang.xiao.utils.FileUtils;
import com.jaredhuang.xiao.utils.MeUtils;
import com.jaredhuang.xiao.utils.bar.ImmersionBar;
import com.jaredhuang.xiao.widget.HorizontalListView;
...
public class ReadStyleActivity extends MBaseActivity implements ColorPickerDialogListener {
    ...
    /**
     * OnPageLoaderCallback that is invoked when a color is selected from the color picker dialog.
    ...
    /**
     * OnPageLoaderCallback that is invoked when the color picker dialog was dismissed.
     * @param dialogId The dialog id used to create the dialog instance.
     */
    @Override
