...
import com.jaredhuang.xiao.view.activity.SettingActivity;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference.getKey().equals(getString(R.string.pk_download_path))) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(getActivity())
                    ...
                    .setPositiveButton(R.string.yes, (dialog, which) -> BookCollectHelp.clearCaches(true))
                    .setNegativeButton(R.string.no, (dialogInterface, i) -> BookCollectHelp.clearCaches(false))
                    .show();
