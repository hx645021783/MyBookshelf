...
import com.jaredhuang.xiao.presenter.SearchBookPresenter;
import com.jaredhuang.xiao.presenter.contract.SearchBookContract;
...
import com.jaredhuang.xiao.view.adapter.SearchBookAdapter;
import com.jaredhuang.xiao.view.adapter.SearchBookshelfAdapter;
import com.jaredhuang.xiao.widget.explosion_field.ExplosionField;
import com.jaredhuang.xiao.widget.recycler.refresh.OnLoadMoreListener;
    ...
    private void initSearchView() {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (newText != null) {
                    List<BookInfoBean> beans = BookCollectHelp.searchBookInfo(newText);
        ...
        if (historyBeans != null) {
            ...
            for (SearchHistoryBean searchHistoryBean : historyBeans) {
                ...
                tagView.setOnClickListener(view -> {
                    ...
                    List<BookInfoBean> beans = BookCollectHelp.searchBookInfo(historyBean.getContent());
                    if (beans.isEmpty()) {
