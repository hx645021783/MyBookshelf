...
import com.jaredhuang.xiao.presenter.ReplaceRulePresenter;
import com.jaredhuang.xiao.presenter.contract.ReplaceRuleContract;
import com.jaredhuang.xiao.utils.ACache;
...
import com.jaredhuang.xiao.view.adapter.ReplaceRuleAdapter;
import com.jaredhuang.xiao.widget.filepicker.picker.FilePicker;
...
public class ReplaceRuleActivity extends MBaseActivity<ReplaceRuleContract.Presenter> implements ReplaceRuleContract.View {
    ...
    public static void startThis(Context context, BookCollectBean shelfBean) {
    ...
    protected void initData() {
        ...
        if (!TextUtils.isEmpty(dataKey)) {
            bookCollectBean = (BookCollectBean) BitIntentDataManager.getInstance().getData(dataKey);
        }
    ...
    public void editReplaceRule(ReplaceRuleBean replaceRuleBean) {
        ReplaceRuleDialog.builder(this, replaceRuleBean, bookCollectBean)
