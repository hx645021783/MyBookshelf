...
class BookContent {
    ...
    Observable<BookContentBean> analyzeBookContent(final Response<String> response, final BaseChapterBean chapterBean, final BaseChapterBean nextChapterBean, BookCollectBean bookCollectBean, Map<String, String> headerMap) {
        baseUrl = NetworkUtils.getUrl(response);
        return analyzeBookContent(response.body(), chapterBean, nextChapterBean, bookCollectBean, headerMap);
    }

    Observable<BookContentBean> analyzeBookContent(final String s, final BaseChapterBean chapterBean, final BaseChapterBean nextChapterBean, BookCollectBean bookCollectBean, Map<String, String> headerMap) {
        return Observable.create(e -> {
            ...
            if (TextUtils.isEmpty(baseUrl)) {
                baseUrl = NetworkUtils.getAbsoluteURL(bookCollectBean.getBookInfoBean().getChapterUrl(), chapterBean.getDurChapterUrl());
            }
