    ...
    private SearchBookBean getItem(AnalyzeRule analyzer, String baseUrl) throws Exception {
        ...
        if (!isEmpty(ruleInfoInit)) {
            ...
            if (ruleInfoInit.startsWith(":")) {
                ...
                item.setName(bookCollectBean.getBookInfoBean().getName());
                item.setAuthor(bookCollectBean.getBookInfoBean().getAuthor());
                item.setCoverUrl(bookCollectBean.getBookInfoBean().getCoverUrl());
                item.setLastChapter(bookCollectBean.getLastChapterName());
                item.setIntroduce(bookCollectBean.getBookInfoBean().getIntroduce());
                return item;
            } else {
