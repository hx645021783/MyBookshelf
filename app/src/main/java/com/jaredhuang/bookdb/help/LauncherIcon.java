...
public class LauncherIcon {
    ...
    private static ComponentName componentNameMain = new ComponentName(MApplication.getInstance(), "com.jaredhuang.bookself.view.activity.WelcomeActivity");
    private static ComponentName componentNameBookMain = new ComponentName(MApplication.getInstance(), "com.jaredhuang.bookself.view.activity.WelcomeBookActivity");
