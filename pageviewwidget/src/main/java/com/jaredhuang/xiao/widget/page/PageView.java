...
import com.jaredhuang.xiao.widget.page.animation.NonePageAnim;
import com.jaredhuang.xiao.widget.page.animation.PageAnimation;
import com.jaredhuang.xiao.widget.page.animation.ScrollPageAnim;
import com.jaredhuang.xiao.widget.page.animation.SimulationPageAnim;
...
//            ToastHelper.getInstance().show("没有上一页");
     ...
     * 获取 PageLoader
     */
    public PageLoader getPageLoader(Activity activity, BookCollectBean bookCollectBean, PageLoader.OnPageLoaderCallback onPageLoaderCallback) {
        ...
        if (!Objects.equals(bookCollectBean.getDomain(), BookCollectBean.LOCAL_TAG)) {
            ...
            String fileSuffix = FileHelp.getFileSuffix(bookCollectBean.getNoteUrl());
            if (fileSuffix.equalsIgnoreCase(FileHelp.SUFFIX_EPUB)) {
                mPageLoader = new PageLoaderEpub(this, bookCollectBean, onPageLoaderCallback);
            } else {
                mPageLoader = new PageLoaderText(this, bookCollectBean, onPageLoaderCallback);
            }
        }
