...
public class PageLoaderEpub extends PageLoader {
    ...
    PageLoaderEpub(PageView pageView, BookCollectBean bookCollectBean, OnPageLoaderCallback onPageLoaderCallback) {
            ...
            e.onComplete();
                ...
                .subscribe(new Observer<BookCollectBean>() {
                    ...
                    public void onNext(BookCollectBean bookCollectBean) {
                        ...
                        // 加载并显示当前章节
                        skipToChapter(bookCollectBean.getDurChapter(), bookCollectBean.getDurChapterPage());
                    }
    ...
    private Observable<BookCollectBean> checkChapterList(BookCollectBean collBook) {
        if (!collBook.getHasUpdate() && !bookChapterBeanList.isEmpty()) {
        ...
        Observable.create((ObservableOnSubscribe<BookCollectBean>) e -> {
            ...
            e.onComplete();
                ...
                .subscribe(new Observer<BookCollectBean>() {
                    ...
                    @Override
                    public void onNext(BookCollectBean bookCollectBean) {
                        Toast.makeText(mPageView.getContext(), "更新完成", 0).show();
                        isChapterListPrepare = true;
                        // 加载并显示当前章节
                        skipToChapter(bookCollectBean.getDurChapter(), bookCollectBean.getDurChapterPage());
                    }
