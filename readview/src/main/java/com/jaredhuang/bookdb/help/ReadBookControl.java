...
import static com.jaredhuang.bookdb.widget.page.PageLoader.DEFAULT_MARGIN_WIDTH;
...
public class ReadBookControl {
    ...
    private ReadBookControl() {
        preferences = ReadDataExt.getInstance().getConfigPreferences();
        initTextDrawable();
    ...
    private void initPageStyle() {
        ...
        if ((bgCustom == 2 || bgCustom == 3) && getBgPath(textDrawableIndex) != null) {
            ...
            Resources resources = ReadViewExt.getInstance().getContext().getResources();
