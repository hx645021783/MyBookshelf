...
import com.jaredhuang.bookdb.help.FileHelp;
...
import com.jaredhuang.bookdb.widget.page.animation.CoverPageAnim;
import com.jaredhuang.bookdb.widget.page.animation.HorizonPageAnim;
import com.jaredhuang.bookdb.widget.page.animation.NonePageAnim;
import com.jaredhuang.bookdb.widget.page.animation.PageAnimation;
import com.jaredhuang.bookdb.widget.page.animation.ScrollPageAnim;
import com.jaredhuang.bookdb.widget.page.animation.SimulationPageAnim;
import com.jaredhuang.bookdb.widget.page.animation.SlidePageAnim;
...
import static com.jaredhuang.bookdb.utils.ScreenUtils.getDisplayMetrics;
...
public class PageView extends View implements PageAnimation.OnPageChangeListener {
     ...
     * 获取 PageLoader
     */
    public PageLoader getPageLoader(Activity activity, BookShelfBean bookShelfBean, PageLoader.Callback callback) {
        ...
        if (!Objects.equals(bookShelfBean.getTag(), BookShelfBean.LOCAL_TAG)) {
            mPageLoader = new PageLoaderNet(this, bookShelfBean, callback) {
                ...
                public ObservableSource<BookContentBean> getBookContent(BookShelfBean book, BookChapterBean bookChapterBean, BaseChapterBean nextChapterBean) {
                    ...
                    return callback.getBookContent(book, bookChapterBean, nextChapterBean);
                }

                @Override
                public Observable<List<BookChapterBean>> getChapterList(BookShelfBean book) {
                    return callback.getChapterList(book);
                }
            };
        } else {
    ...
    public void autoChangeSource() {
        ...
        if (mTouchListener != null) {
            mTouchListener.autoChangeSource();
        }
    }
