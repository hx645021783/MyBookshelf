...
package com.jaredhuang.bookdb.bean;

import android.text.TextUtils;

import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import com.jaredhuang.bookdb.ReadDataExt;
...
public class BookShelfBean implements Cloneable, BaseBookBean {
    ...
    private Boolean replaceEnable = ReadDataExt.getInstance().getConfigPreferences().getBoolean("replaceEnableDefault", true);
    ...
    public Map<String, String> getVariableMap() {
        if (variableMap == null && !TextUtils.isEmpty(variable)) {
            variableMap = new Gson().fromJson(variable, new TypeToken<Map<String, String>>() {
            }.getType());
        }
        return variableMap;
    }
    ...
    public Boolean getReplaceEnable() {
        return replaceEnable == null ? ReadDataExt.getInstance().getConfigPreferences().getBoolean("replaceEnableDefault", true) : replaceEnable;
    }
